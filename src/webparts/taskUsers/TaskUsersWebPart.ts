...
import * as strings from 'TaskUsersWebPartStrings';
import TaskUsers from './components/TaskUsers';
import { ITaskUsersProps } from './components/ITaskUsersProps';
...
export default class TaskUsersWebPart extends BaseClientSideWebPart<ITaskUsersWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ITaskUsersProps> = React.createElement(
      TaskUsers,
      {
